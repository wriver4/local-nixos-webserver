...
# This module adds webserver-specific virtual hosts to existing nginx configuration
...

{
  ...
  # Additional nginx configuration for webserver
  services.nginx = {
    # Ensure nginx is enabled (uses mkDefault to not conflict)
    enable = lib.mkDefault true;
    
    # Add webserver-specific HTTP configuration
    appendHttpConfig = lib.mkAfter ''
      # Webserver-specific optimizations
      client_max_body_size 64M;
      
      # Security headers for webserver virtual hosts
